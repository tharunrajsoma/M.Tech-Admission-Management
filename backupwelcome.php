...
<?php
   ...
   $v='9999-99-99';
   $cnstr='N';
   $coln = array("APPLICATION NUMBER","NAME","BIRTH CATEGORY","DISABLE STATUS", "REGISTERED EMAIL ID", "PERCENTAGE OF MARKS", "PERCENTAGE OF GP",  "GATE SCORE", "GATE AIR", "VALID UPTO", "PROGRAM TYPE2","PRIORITY2","PROGRAM TYPE3","PRIORITY3", "PROGRAM TYPE1", "PRIORITY1", "GENDER", "MARITAL STATUS","DATE OF BIRTH","PLACE OF BIRTH","FATHER NAME","DISABLE DESCRIPTION","MOBILE NUMBER","DEGREE TYPE NAME","DEGREE NAME","INSTITUTE NAME","UNIVERSITY","SPECILIZATION","DIVISION","YEAR OF PASS","SECURED MARKS","TOTAL MARKS","SECURED GP","TOTAL GP","EXPERIENCE TYPE NAME","ORGANIZATION NAME","DESIGNITION","NATURE OF WORK","FROM DATE","TO DATE"," DURATION");
   //  ENTRY EXAM NAME REGISTRATION NUMBER EXAM YEAR SPECILAZATION DESCRIPTION PRIORITY  PROGRAM TYPE1 PRIORITY1  PRIORITY2 PROGRAM TYPE3 PRIORITY3 REFERENCE TYPE NAME AMOUNT
 ...
 if($p1=='NULL')
 {
    if($p2=='NULL')
   {
      if($p0=='NULL')
      {
        ...
        $sql = "SELECT * FROM `TABLE 1` where `GATE SCORE` > $score1 and `GATE SCORE` < $score2 and `DISABLE STATUS`!='$d' ORDER BY `$st` desc LIMIT  $start_from, ".$results_per_page;
      ...
      else
      {
        ...
        $sql = "SELECT * FROM `TABLE 1` where `GATE SCORE` > $score1 and `GATE SCORE` < $score2 and `PROGRAM TYPE1`='$p0' and `DISABLE STATUS`!='$d' ORDER BY `$st` desc LIMIT  $start_from, ".$results_per_page;
      }
   }
   else
   {
      if($p0=='NULL')
      {
        ...
        $sql = "SELECT * FROM `TABLE 1` where `GATE SCORE` > $score1 and `GATE SCORE` < $score2 and `PROGRAM TYPE3`='$p2' and `DISABLE STATUS`!='$d' ORDER BY `$st` desc LIMIT  $start_from, ".$results_per_page;
      }
      else
      {
        ...
        $sql = "SELECT * FROM `TABLE 1` where `GATE SCORE` > $score1 and `GATE SCORE` < $score2 and `PROGRAM TYPE3`='$p2' and `PROGRAM TYPE1`='$p0' and `DISABLE STATUS`!='$d' ORDER BY `$st` desc LIMIT  $start_from, ".$results_per_page;
      }
 ...
 else
 {
   if($p2=='NULL')
   {
      if($p0=='NULL')
      {
        ...
        $sql = "SELECT * FROM `TABLE 1` where `GATE SCORE` > $score1 and `GATE SCORE` < $score2 and `PROGRAM TYPE2`='$p1' and `DISABLE STATUS`!='$d' ORDER BY `$st` desc LIMIT  $start_from, ".$results_per_page;
      }
      else
      {
        ...
        $sql = "SELECT * FROM `TABLE 1` where `GATE SCORE` > $score1 and `GATE SCORE` < $score2 and `PROGRAM TYPE2`='$p1' and `PROGRAM TYPE1`='$p0' and `DISABLE STATUS`!='$d' ORDER BY `$st` desc LIMIT  $start_from, ".$results_per_page;
      }
   }
   else
   {
      if($p0=='NULL')
      {
        ...
        $sql = "SELECT * FROM `TABLE 1` where `GATE SCORE` > $score1 and `GATE SCORE` < $score2 and `PROGRAM TYPE2`='$p1' and `PROGRAM TYPE3`='$p2' and `DISABLE STATUS`!='$d' ORDER BY `$st` desc LIMIT  $start_from, ".$results_per_page;
      }
      else
      {
        ...
        $sql = "SELECT * FROM `TABLE 1` where `GATE SCORE` > $score1 and `GATE SCORE` < $score2 and `PROGRAM TYPE2`='$p1' and `PROGRAM TYPE3`='$p2' and `PROGRAM TYPE1`='$p0' and `DISABLE STATUS`!='$d' ORDER BY `$st` desc LIMIT  $start_from, ".$results_per_page;
      }
